...
void
FibHelper::AddRoute(const std::string& nodeName, const std::string& prefix, uint32_t faceId,
                    int32_t metric)
{
...
void
FibHelper::AddRoute(const std::string& nodeName, const std::string& prefix,
