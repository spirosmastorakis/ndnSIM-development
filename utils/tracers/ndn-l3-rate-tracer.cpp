...
static std::list<std::tuple<boost::shared_ptr<std::ostream>, std::list<Ptr<L3RateTracer>>>>
  g_tracers;
...
L3RateTracer::Print(std::ostream& os) const
{
  ...
  {
    std::map<shared_ptr<const Face>, std::tuple<Stats, Stats, Stats, Stats>>::iterator stats =
